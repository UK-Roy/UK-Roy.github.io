...
## Objective
To build a complete autonomous navigation pipeline using ROS for a mobile robot.

## My Role
- Implemented SLAM using gmapping  
- Integrated AMCL and RRT-based motion planning  
